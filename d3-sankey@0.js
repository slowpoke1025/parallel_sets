...
!(function (n, t) {
  "object" == typeof exports && "undefined" != typeof module
    ? t(exports, require("d3-array"), require("d3-shape"))
    : "function" == typeof define && define.amd
    ? define(["exports", "d3-array", "d3-shape"], t)
    : t(((n = n || self).d3 = n.d3 || {}), n.d3, n.d3);
})(this, function (n, t, e) {
  "use strict";
  function o(n) {
  ...
  (n.sankey = function () {
    ...
    function z() {
      ...
      return (
        (function ({ nodes: n, links: t }) {
          for (const [t, e] of n.entries())
            (e.index = t), (e.sourceLinks = []), (e.targetLinks = []);
          const e = new Map(n.map((t, e) => [m(t, e, n), t]));
          for (const [n, o] of t.entries()) {
            o.index = n;
            let { source: t, target: r } = o;
            "object" != typeof t && (t = o.source = h(e, t)),
              "object" != typeof r && (r = o.target = h(e, r)),
              t.sourceLinks.push(o),
              r.targetLinks.push(o);
          }
          if (null != o)
            for (const { sourceLinks: t, targetLinks: e } of n)
              t.sort(o), e.sort(o);
        })(r),
        (function ({ nodes: n }) {
          for (const e of n)
            e.value =
              void 0 === e.fixedValue
                ? Math.max(t.sum(e.sourceLinks, c), t.sum(e.targetLinks, c))
                : e.fixedValue;
        })(r),
        (function ({ nodes: n }) {
          const t = n.length;
          ...
          for (; e.size; ) {
            for (const n of e) {
              n.depth = r;
              for (const { target: t } of n.sourceLinks) o.add(t);
            }
        ...
        (function ({ nodes: n }) {
          ...
          for (; e.size; ) {
            for (const n of e) {
              n.height = r;
              for (const { source: t } of n.targetLinks) o.add(t);
            }
            if (++r > t) throw new Error("circular link");
            (e = o), (o = new Set());
          }
        ...
        (function (o) {
          const r = (function ({ nodes: n }) {
            ...
            for (const t of n) {
              const n = Math.max(
                0,
                Math.min(o - 1, Math.floor(v.call(null, t, o)))
              );
              (t.layer = n),
                (t.x0 = y + n * r),
                (t.x1 = t.x0 + w),
    ...
    function j(n, t, o) {
      for (let r = 1, i = n.length; r < i; ++r) {
        ...
        for (const n of i) {
          let e = 0,
            o = 0;
          for (const { source: t, value: r } of n.targetLinks) {
    ...
    function E(n, t, o) {
      for (let r = n.length - 2; r >= 0; --r) {
        ...
        for (const n of i) {
          let e = 0,
            o = 0;
          for (const { target: t, value: r } of n.sourceLinks) {
    ...
    function P({ sourceLinks: n, targetLinks: t }) {
      if (void 0 === o) {
        for (const {
    ...
    function _(t, e) {
      ...
      for (const { target: r, width: i } of t.sourceLinks) {
        if (r === e) break;
        o += i + n;
      }
      for (const { source: n, width: r } of e.targetLinks) {
        if (n === t) break;
        o -= r;
      }
      return o;
    ...
    function C(t, e) {
      ...
      for (const { source: r, width: i } of e.targetLinks) {
        if (r === t) break;
        o += i + n;
      }
      for (const { target: n, width: r } of t.sourceLinks) {
        if (n === e) break;
        o -= r;
      }
      return o;
    ...
    return (
      ...
      (z.nodeId = function (n) {
        return arguments.length
          ? ((m = "function" == typeof n ? n : i(n)), z)
          : m;
      }),
      (z.nodeAlign = function (n) {
        return arguments.length
          ? ((v = "function" == typeof n ? n : i(n)), z)
          : v;
      }),
      ...
      (z.extent = function (n) {
        return arguments.length
          ? ((y = +n[0][0]), (L = +n[1][0]), (k = +n[0][1]), (p = +n[1][1]), z)
          : [
              [y, k],
              [L, p],
            ];
